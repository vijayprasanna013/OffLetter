<div class="kt-portlet kt-portlet--tabs">
    <div class="kt-portlet__head">
        <div class="kt-portlet__head-toolbar">
            <ul class="nav nav-tabs nav-tabs-line nav-tabs-line-success nav-tabs-line-2x" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" data-toggle="tab" href="#list_template" role="tab" aria-selected="true">
                        <i class="la la-cog"></i> List Of Templates
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#add_template" role="tab" aria-selected="false">
                        <i class="la la-briefcase"></i> Add a Template
                    </a>
                </li>
            </ul>
        </div>
    ...
    <div class="kt-portlet__body">
        <div class="tab-content">
            <div class="tab-pane active" id="list_template" role="tabpanel">
                Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.
            </div>
            <div class="tab-pane" id="add_template" role="tabpanel">
                <div class="kt-pricing-2">
                    <div class="kt-pricing-2__head">
                        <div class="btn-group nav btn-group btn-group-pill btn-group-air" role="group">
                            <button type="button" class="btn btn-wide btn-uppercase btn-bolder active" data-toggle="tab" href="#Uploadtemp" role="tab" aria-expanded="true" aria-selected="true">
                                Upload Template
                            </button>
                            <button type="button" class="btn btn-wide btn-uppercase btn-bolder" data-toggle="tab" href="#createtemp" role="tab" aria-expanded="false" aria-selected="false">
                                Create Template
                            </button>
                        </div>
                    </div>
